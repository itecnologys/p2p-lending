...
Lending-Club Web3 / Plataforma P2P de crédito nativa vinculada a **Stablecoins (USDC/USDT)**, desenhada arquitetonicamente para operar de maneira descentralizada (off-BACEN centralization) conectando:
- **Aplicantes** (investidores): aportam capital em Pools de Stablecoins para contornar a ineficiência do spread bancário e mitigar riscos burocráticos primários, recebendo 3–5% a.m. 
- **Usuários** (tomadores): recebem crédito fiduciário pré-aprovado originado do fundo via FIDC em blocos de R$40 num cartão pré-pago.

> *Nota Estratégica:* A estrutura como "SCD regulada pelo BACEN (CMN 5050/2022)" existe e está desenhada exclusivamente como uma opção de apresentação / arcabouço *stand-by* de regulação futura, no caso da consolidação escalada exigir um formato institucional padrão. Mas, hoje, a empresa nasce na base descentralizada com blindagem patrimonial externa.
